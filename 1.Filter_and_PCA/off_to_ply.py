...
2020-04-19
孙正茂
把ModelNet中的.off文件转存成.ply文件，如果下载的不是.off文件，则不需要执行此文件
'''
import os
import numpy as np
...
if __name__ == '__main__':
    # ply目标文件产生路径
    ply_data_dir = '/media/sunzhengmao/SZM/PointCloud/ModelNet40/ModelNet40_ply'
    # off文件所在路径
    off_data_dir = '/media/sunzhengmao/SZM/PointCloud/ModelNet40/ModelNet40_off'
